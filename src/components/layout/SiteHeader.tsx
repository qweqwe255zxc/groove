...
export default function SiteHeader() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 flex items-center justify-between px-6 py-5 mix-blend-difference sm:px-10">
      <HashLink
        href="#top"
        className="-m-2 p-2 font-display text-lg italic tracking-tight"
      >
        spinner
      </HashLink>
      ...
      <button
        ...
        className="-m-2 flex items-center gap-3 p-2 text-xs uppercase tracking-[0.2em] text-fg cursor-pointer"
